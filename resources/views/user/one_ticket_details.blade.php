@extends('user.layout')
@section('content')
@section('one_ticket_details_styles')
...
<!-- <div class="manage-ticket-div">
    <p>Check the current number being called before returning to your groceries.</p>
        <a href="/number-served" class="btn btn-warning btn-md border border-dark">Check Number Being Served</a>   
</div> -->
<div class="view-ticket-div mt-2">
    {{-- <a href="/view-ticket-size-pdf/{{ $ticketDetails->id }}/letter/" class="btn btn-warning btn-md border border-dark" style="text-decoration: none;">View Print Friendly Version (letter size)</a> --}}
    <a href="/view-ticket-size-pdf/{{ $ticketDetails->id }}/card/" class="btn btn-warning btn-md border border-dark">Print</a>
</div>
...
@section('one_ticket_details_script')
<script>
