@extends('user.layout')
@section('content')
@section('multiple_users_ticket_details_styles')
<style>
...
<div class="view-ticket-div">
    <a href="/view-multiple-users-ticket-size-pdf/{{ $generatedTicketDetails->multiple_id }}/card/" class="btn btn-warning btn-md border border-dark">Print</a>
</div>
...
@section('multiple_users_ticket_details_script')
