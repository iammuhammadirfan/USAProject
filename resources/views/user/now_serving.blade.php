...
@stop
<div id="todaysDateDiv" style="display: flex;align-items: center;justify-content: space-around;">
    <p id="todaysDate">              
        {{ $todaysDate }}
    </p>
</div>
...
<div style="display: flex;justify-content: space-between;align-items: center;">
    ...
    <div id="loggedInUserTicket" class="d-none">
        ...
        <p class="user-ticket-number" style="text-align: center; color:red;font-size: 70px;font-weight: 500;margin: auto;"></p>
    </div>
</div>
