@extends('admin.layout')
            @section('content')
            @section('admin_activity_log_styles')
                {{-- datatables --}}
                    ...
                    <div class="tab-pane fade active show" id="signUpTab" role="tabpanel">
                        ...
                        <!-- <div class="row">
                            <div class="col-md-12 col-lg-12"> -->
                                ...
                                <table id="myActivityLog" class="table table-bordered" style="width:100%;">
            ...
            @section('admin_activity_log_script')
                    ...
                    function filter_activity()
                        {
                            ...
                            const url = '/admin/admin-activity-log';
                            ...
                            $.ajax({
                                ...
                                success: function(response) 
                                {
                                    ...
                                    // myActivityLog.ajax.reload(null, false);
                                    $('#myActivityLog').DataTable().destroy();
						            $('#myActivityLog').removeClass('table-striped');
						
                                    const staff_id=$('.staff-id').val();
                                    const activity_date=$('#activityDate').val();
                                
                                    $('#myActivityLog').removeClass('d-none');
