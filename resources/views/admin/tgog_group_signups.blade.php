@extends('admin.layout')
            ...
            <style>
                    ...
                    .new-volunteer-group-user,.new-volunteer-group-signup
                    {
                ...
                .datatable-dropdown
                {
                    display: flex;align-items: center;gap: 5px; width:60%; border-radius:5px;
                }
                .dropbtn {
                    display: inline-block;
                    color: white;
            ...
            @stop
                <div class="row m-2" style="width:98%;">
                    <div class="col-lg-4">
                        ...
                        <table id="volunteerGrouphomeUsersTable" class="table table-bordered" style="width:100%;">
                    ...
                    <div class="col-lg-8">
                        <!-- <nav class="mt-5">
                            <div class="nav nav-tabs mb-3" role="tablist">
                                <button class="nav-link active nav-volunteers-tab" data-bs-toggle="tab" data-bs-target="#volunteersTab" type="button" role="tab" aria-controls="volunteersTab" aria-selected="true">Volunteer</button>
                                <button class="nav-link nav-group-homes-tab" data-bs-toggle="tab" data-bs-target="#groupHomesTab" type="button" role="tab" aria-controls="groupHomesTab" aria-selected="false">Group Homes</button>
                            </div>
                        </nav>
                        <div class="tab-content p-3 border bg-light" id="nav-tabContent">
                            
                            <div class="tab-pane fade" id="groupHomesTab" role="tabpanel"> -->
                                <h3 style="text-align: center;">Today Group Home Signups</h3>
                                <table id="groupHomesSignupsTable" class="table table-bordered" style="width:100%;">
                                    <thead class="bg-info text-white">
                                    <tr>
                                        <td>Number</td>
                                        <td>Name</td>
                                ...
                                <span class="new-volunteer-group-signup" sign-up-type="2">Add New Record</span>

                                <div class="volunteer-group-signups-dashboard-holder">
                                    <div class="details-holder" style="background-color: rgb(204, 102, 255)">
                                        <p style="font-size: 30px;">Total Group Home Sign-Ups</p>
                                        <p style="font-size:70px; margin-top: -30px;" id="totalGroupHomeSignupsCount">{{ $group_homes_signups_count }}</p>
                                    </div>
                                    <div class="details-holder" style="background-color:rgb(51, 204, 255)">
                                        <p style="font-size: 30px;">Total Group Home Served</p>
                                        <p style="font-size:70px; margin-top: -30px;" id="totalGroupHomesServedCount">{{ $group_homes_served_count }}</p>
                                    </div>
                                    <div class="details-holder" style="background-color: rgb(204, 255, 153)">
                                        <p style="font-size: 30px;">Total Group Home Remaining</p>
                                        <p style="font-size:70px; margin-top: -30px;" id="totalGroupHomesRemainingCount">{{ $group_homes_unserved_count }}</p>
                                    </div>
                                </div>
                            <!-- </div>
                        </div> -->
