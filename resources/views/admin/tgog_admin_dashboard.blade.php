            ...
            @stop
                ...
                <div class="tab-content p-3 border bg-light" id="nav-tabContent">
                    <div class="tab-pane fade active show" id="signUpTab" role="tabpanel">
                        ...
                        <!--<div class="row"> -->
                             <p style="text-align: center; font-size: 30px; font-weight: 600; margin-bottom: 40px;">
                             Hello, {{ Str::title(Auth::user()->first_name . ' ' . Auth::user()->last_name) }}
                            </p>

                            @if($truncatedMemo)
                                <div style="width: 70%; margin: auto;">
                                    <p style="font-size: 24pt;">{{ $truncatedMemo }}</p>
                                </div>
                            @endif
            ...
            <script src="//cdn.jsdelivr.net/npm/alertifyjs@1.14.0/build/alertify.min.js"></script>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        ...
                        //                 roleName = (ticketDetails.ticketGeneratorRole == 1) ? 'TGOG' : 
