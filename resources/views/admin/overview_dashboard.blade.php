...
<!-- <div class="row mt-5">
    <div class="col-md-10 mx-auto">
        <div style="display: flex; justify-content:space-between; align-items:center;">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-warning btn-sm border border-dark mb-2">Main Menu</a>
            <a href="{{ route('admin.number_control') }}" class="btn btn-warning btn-sm border border-dark mb-2">Number Control</a>
        </div>
    </div>
</div> -->
