                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div style="display: flex; justify-content:flex-end; align-items:center;">
                                    <a href="/admin/view-signups-table-pdf" target="_blank" class="btn btn-warning btn-sm btn-md btn-lg border border-dark rounded">Print</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12 col-lg-12">
                                <div style="display: flex; justify-content:space-between; align-items:center;">
                                    <a href="{{ route('admin.dashboard') }}" class="btn btn-warning btn-sm btn-md btn-lg border border-dark" style="border: 1px solid #343a40;">Main Menu</a>
                                    <a href="{{ route('admin.register.recipient.screen') }}" class="btn btn-warning btn-sm btn-md btn-lg border border-dark rounded">Register
                                        New Recipient</a>
                                </div>
                            </div>
                        </div>
                    ...
                    $(document).on('click', '.control-number', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                // {
                                //     $('#errorCodeMsg').removeClass('d-none');
                                //     $('#errorCodeMsg').text(response.message);
                                // }
                            }
                        });
                    });
                            ...
                            $.ajax({
                                ...
                                success: function(response)
                                {
                                    ...
                                    else if (response.status == 200)
                                    {
                                        ...
                                        if ($('#barcodeScanTicketModal').hasClass('show') && Number($('#barcodeScanUserId').val()) == userId) 
                                        {
                                            if(checkedIn == 'No')
                                            {
                                        ...
                                        } else if($('#barcodeScanTicketModal').hasClass('show') && Number($('#barcodeScanUserId').val()) !== userId) 
                                        {
                                    ...
                                    else if (response.status == 201)
                                    {
                                        ...
                                        if ($('#barcodeScanTicketModal').hasClass('show') && Number($('#multipleIdUserIdScan').val()) == user_id) 
                                        {
                                            if($('#multipleIdUserTicketStatusScan').val() == 0)
                                            {
                                        ...
                                        } else if($('#barcodeScanTicketModal').hasClass('show') && Number($('#multipleIdUserIdScan').val()) !== user_id) 
                                        {
                                            $('#barcodeScanTicketModal').modal('toggle');
                                            ...
                                            $('.scanned-case-number').closest'(tr').addClass('highlight-scanned-row');
                                ...
                                success: function(response) 
                                {
                                    ...
                                    if (status == 1 && multiple !== null) 
                                    {
                                        $.each(multiple, function(i, item) {
                                            $('#checkInButton'+multiple[i]).removeClass('btn-danger');
                                            $('#checkInButton'+multiple[i]).html('');

                                            $('#checkInButton'+multiple[i]).addClass('btn-success');
                                            $('#checkInButton'+multiple[i]).html('Yes');
                                        });
                                    ...
                                    {
                                        $('#checkInButton'+checkedInTicketId).removeClass('btn-danger');
                                        $('#checkInButton'+checkedInTicketId).html('');

                                        $('#checkInButton'+checkedInTicketId).addClass('btn-success');
                                        $('#checkInButton'+checkedInTicketId).html('Yes');

                                        $('.check-in-btn').not(this).prop("disabled", false).css("cursor", "pointer");
                                    } else if (status == 0 && multiple == null)
                                    {
                                        $('#checkInButton'+checkedInTicketId).removeClass('btn-success');
                                        $('#checkInButton'+checkedInTicketId).html('');

                                        $('#checkInButton'+checkedInTicketId).addClass('btn-danger');
                                        $('#checkInButton'+checkedInTicketId).html('No');

                                        $('.check-in-btn').not(this).prop("disabled", false).css("cursor", "pointer");
                                    } else if (status == 0 && multiple !== null) 
                                    {
                                        $.each(multiple, function(i, item) {
                                            $('#checkInButton'+multiple[i]).removeClass('btn-success');
                                            $('#checkInButton'+multiple[i]).html('');

                                            $('#checkInButton'+multiple[i]).addClass('btn-danger');
                                            $('#checkInButton'+multiple[i]).html('No');
                                        });
