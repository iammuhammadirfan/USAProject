...
@section('content')
@section('overview_dashboard_copy_styles')
    {{-- datatables --}}
    ...
    <div class="col-md-10 mx-auto">
        <div class="overview-dashboard-holder">
            ...
            <div class="details-holder" style="background-color: rgb(204, 255, 153)">
                <p style="font-size: 30px;">Total Remaining</p>
        ...
        <div class="overview-dashboard-holder-2">
            <div class="details-holder" style="color: red;background-color: black;">
                ...
                <p style="font-size:70px;" class="ticket-served"></p>
            </div>
        </div>
    </div>
</div>
...
{{-- <div class="row mt-5">
    <h3 style="text-align: center;">Now Serving</h3>
...
@section('overview_dashboard_copy_script')
    {{-- pusher js --}}
        ...
        $(document).ready(function() {
            ...
            var remainingticketsTable=$('#noShowsTicketsTable').DataTable({
                ...
                columns: [
                    ...
                    {  data: 'projected_time',name:'projected_time',orderable:false,searchable:false },
            ...
            channel.bind('uncheckedin-tickets-data', function(data) {
                ...
                {       
                    ...
                    .add({
                        ...
                        fname: ticketData.firstName,
                        lname: ticketData.lastName,
                        case_number: ticketData.caseNumber,
                        projected_time: ticketData.projected_return_time,
                        created: formattedTime,
                        checked_in:checkedInStatus
                    });
                }

                if(ticketData.checked_in == 1)
                {
                    var rowIndex = remainingticketsTable.column(0).data().indexOf(ticketData.ticket_number);

                    if(rowIndex > 0)
                    {
                        remainingticketsTable.row(rowIndex).remove();
                    }
                }
                ...
                $.each(ticketsData, function(i, item) {
                    ...
                    if(ticketsData[i].checked_in == 0)
                    {
                        ...
                        .add({
                            ...
                            projected_time: ticketsData[i].projected_return_time,
                            created: formattedTime,
                            checked_in:checkedInStatus
                        })
