...
<div class="mt-5 mx-auto" style="width:80%;">
    <h2 style="text-align:center;font-size:22px; font-weight:500;margin-bottom:10px;">Register New Recipient</h2>
            
    <form method="POST"  class="add-new-record-form">
        @csrf
        ...
        <p id="ticketBeingProcessed" style="font-size: 20px;font-weight: 600;text-align: center;font-style: italic;" class="d-none text-danger"></p>
        ...
        $(document).on('click', '.add-new-record-btn', function(e) 
			{
                ...
                $('#ticketBeingProcessed').text('The Details are being processed. Please wait...').removeClass("d-none");
                ...
                $.ajax({
                    ...
                    success: function(response) 
					{
                        ...
                        $('#ticketBeingProcessed').addClass("d-none");
