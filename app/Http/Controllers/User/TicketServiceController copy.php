...
public function create_one_ticket_details(Request $request)
{
    ...
    $latestSavedData=DB::table('generated_tickets')->whereDate('created_at',$todaysDate)->select('ticket_number','created_at')
...
public function create_multiple_tickets_details(Request $request)
{
        ...
        $response_time = 'Response time: ' . $seconds . ' seconds and microseconds ' . $microseconds;
